 ...
 * @author nbnrc
 */
public class PrismaJajarGenjang extends JajaranGenjang { // Mewarisi JajaranGenjang untuk alasnya
    private double tinggiPrisma; // Bisa mutable dengan setter

    // Konstruktor utama
    public PrismaJajarGenjang(double alasJajaranGenjang, double tinggiAlasJajaranGenjang, 
